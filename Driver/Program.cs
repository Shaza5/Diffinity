...
internal class Program
{
    ...
    {
        var DEV002 = new DbServer("DEV002", Environment.GetEnvironmentVariable("devCs"));
        ...
        string IndexPage = DbComparer.Compare(DEV002,CMH, filter:DbObjectFilter.ShowUnchanged);
        #region Optional
