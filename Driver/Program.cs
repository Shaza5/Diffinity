...
internal class Program
{
    ...
    {
        var MyDbV1 = new DbServer("DEV002", Environment.GetEnvironmentVariable("dev2cs"));
        var MyDbV2 = new DbServer("Corewell", Environment.GetEnvironmentVariable("connectionString"));
        string IndexPage = DbComparer.Compare(MyDbV1, MyDbV2, threadCount:20);
        #region Optional:
